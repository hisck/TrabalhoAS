...
import { AcompanhamentoComponent } from 'app/entities/acompanhamento/acompanhamento.component';
...
describe('Component Tests', () => {
    describe('Acompanhamento Management Component', () => {
        let comp: AcompanhamentoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AcompanhamentoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.acompanhamentos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
