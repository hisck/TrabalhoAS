...
import { SobremesaComponent } from 'app/entities/sobremesa/sobremesa.component';
...
describe('Component Tests', () => {
    describe('Sobremesa Management Component', () => {
        let comp: SobremesaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SobremesaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.sobremesas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
