...
import { VegetarianoComponent } from 'app/entities/vegetariano/vegetariano.component';
...
describe('Component Tests', () => {
    describe('Vegetariano Management Component', () => {
        let comp: VegetarianoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(VegetarianoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.vegetarianos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
