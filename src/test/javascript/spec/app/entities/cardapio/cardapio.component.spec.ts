...
import { CardapioComponent } from 'app/entities/cardapio/cardapio.component';
...
describe('Component Tests', () => {
    describe('Cardapio Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.cardapios[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
