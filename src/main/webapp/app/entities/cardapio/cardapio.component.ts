...
export class CardapioComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.cardapioService
            ...
            .subscribe(
                (res: HttpResponse<ICardapio[]>) => this.paginateCardapios(res.body, res.headers),
    ...
    trackId(index: number, item: ICardapio) {
        return item.id;
    }
    ...
    protected paginateCardapios(data: ICardapio[], headers: HttpHeaders) {
